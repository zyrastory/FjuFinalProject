...
ax3.plot(df.index,macd,label='macd dif')
ax3.plot(df.index,signal,label='signal dea')


ax1.set_title('txf-1day') 
ax1.set_xlabel("(time)")
ax1.xaxis.set_label_coords(1.025, 0)

ax1.set_ylabel("(price)",rotation=0)
