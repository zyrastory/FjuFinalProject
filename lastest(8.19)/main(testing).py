...
class firstWindow(QWidget):
    ...
    def setupUi(self,MainWindow):
        ...
        MainWindow.setStyleSheet("#MainWindow { border-image: url(./icon/trader.png) 0 0 0 0 stretch stretch; }")
...
class stockWindow(QWidget):
    def __init__(self, parent = None):
        ...
        self.listWidget.addItems(["中石化","台泥"])
        self.listWidget.setFixedSize(200,150)
        ...
        self.listWidget.move(200, 50) #商品清單

        self.start.move(100,250)    #起始時間標籤
        self.year.move(150, 250)
        self.month.move(250, 250)
        self.day.move(350, 250)

        self.end.move(100,300)  #結束時間標籤
        self.year2.move(150,300)
        self.month2.move(250,300)
        self.day2.move(350,300)
        
        self.k.move(100,375)
        self.scope.move(180,375)
        self.Tcount.move(350,375)


        self.subbutton = QPushButton('確認',self)
        self.subbutton.move(400, 500)

        backbutton = QPushButton('back \n返回 \nリターン \nбуцах',self)
        backbutton.move(550, 480)


        self.num = ""
        self.num2 = ""
        
        self.subbutton.clicked.connect(self.compare) # 比較如果時間不符跳警示窗
    ...
    def tt(self):
        self.num = str(self.listWidget.currentItem().text())
...
class chooseWindow(QWidget):
    def __init__(self, parent = None):
        ...
        self.strategycombo.addItems(["atr","bollinger","cross","cumret","highlow",\
            "hurst","linebreak","linreg","ma","macd","ratio","roc","rsi","stats","stoch",\
            "vwap"])

        self.strategycombo.move(200, 100)
        strategybutton = QPushButton('確認',self)
        strategybutton.move(400, 500)
        self.strategycombo.activated[str].connect(self.onActivated)
        self.fff=""
        strategybutton.clicked.connect(lambda:self.pyalgostrategy(self.strategycombo.currentText()))
