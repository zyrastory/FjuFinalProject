...
class firstWindow(QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.button.clicked.connect(self.kline)
    ...
    def child(self):
        self.w2 = stockWindow()
        self.w2.child.connect(self.close)
        print("9487")
...
class stockWindow(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self.subbutton.move(50, 150)
        
        #self.subbutton.clicked.connect(self.firstWindow.kline)
        #self.subbutton.clicked.connect(self.close)
    def tofather(self):
        print("5487")
        self.child.emit()
...
class MainWindow(QMainWindow, firstWindow):
    def __init__(self, parent=None):
        ...
        self.stockWindow.subbutton.clicked.connect(self.kkline)
